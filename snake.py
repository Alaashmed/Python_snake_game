...
class Food:
    ...
    def __init__(self):
        ...
        y = random.randint(0, int((GAME_HIGHT/SPACE_SIZE))-1)*SPACE_SIZE
        self.coor = [x,y]
...
def check_collisions(snake):
    ...
    for body_part in snake.coors[1:]:
...
y = int((screen_height/3) - (window_height/3))
